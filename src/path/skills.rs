...
impl Path {
  ...
  pub fn skills_full(&self) -> Vec<Skill> {
    self
      ...
      .unwrap_or_default()
      .into_iter()
      .filter(|skill| skill.training_cost == TrainingCost::Full)
      .collect()
  }
  ...
  pub fn skills_half(&self) -> Vec<Skill> {
    self
      ...
      .unwrap_or_default()
      .into_iter()
      .filter(|skill| skill.training_cost == TrainingCost::Half)
      .collect()
  }
  ...
  pub fn spells(&self) -> Vec<Skill> {
    self
      ...
      .unwrap_or_default()
      .into_iter()
      .filter(|skill| skill.training_cost == TrainingCost::Spell)
      .collect()
  }
  ...
  pub fn cantrips(&self) -> Vec<Skill> {
    self
      ...
      .unwrap_or_default()
      .into_iter()
      .filter(|skill| skill.training_cost == TrainingCost::Cantrip)
      .collect()
  }
}
