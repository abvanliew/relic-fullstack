      ...
      .filter_map( |class| {
        if let Some( bonus ) = map.get(class) {
          ...
          Some( match class {
            ...
            ModifierClass::PathFeature => format!( "Learn {value} features from your paths" ),
            ModifierClass::PathCoreFeature => format!( "Learn {value} core features from your paths" ),
            ModifierClass::PathMinorFeature => format!( "Learn {value} minor features from your paths" ),
            ModifierClass::PathSpell => format!( "Learn {value} spells from your paths" ),
            ModifierClass::PathCantrip => format!( "Learn {value} cantrips from your paths" ),
...
fn ordered_modifier_class() -> Vec<ModifierClass> {
  return vec![
    ...
    ModifierClass::PathCoreFeature,
    ModifierClass::PathMinorFeature,
    ModifierClass::PathSpell,
    ModifierClass::PathCantrip,
