...
// use crate::modifiers::prelude::{opt_sum, InstanceBonus, StackingBonus};
...
//     let Some(bonus) = list.get(index) else {
//       return None;
//     };
...
//     for r in 1..=rank {
//       let Some(bonus) = self.bonus(class, r) else {
//         continue;
//       };
//       total += bonus;
//     }
...
//         "Increase {max_rank} {name}'s maxmimum and current rank by 1"
//       ));
//     }
//     return elements;
//   }
...
//       elements.push(format!(
//         "+{pool_all_magic} to all {name} resource pools size"
//       ));
//     }
//     return elements;
//   }
...
//   let Some(bonus) = growth.bonus(&class, rank) else {
//     return rsx!();
//   };
