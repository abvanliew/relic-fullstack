...
pub fn EquipmentPage() -> Element {
  ...
  return rsx! {
    div {
      ...
      WeaponExplainer {}
      div {
        class: "grid dim-table padded-grid alt-background",
      ...
      div {
        class: "grid dim-table padded-grid alt-background break-before",
...
pub fn WeaponExplainer() -> Element {
  rsx! {
    div {
      ...
      div { class: "underline highlight", "Weapon & Armor Characteristics" }
